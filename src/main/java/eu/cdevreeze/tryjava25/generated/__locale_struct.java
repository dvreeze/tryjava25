...
public class __locale_struct {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(13, stdio_string.C_POINTER).withName("__locales"),
        stdio_string.C_POINTER.withName("__ctype_b"),
        stdio_string.C_POINTER.withName("__ctype_tolower"),
        stdio_string.C_POINTER.withName("__ctype_toupper"),
        MemoryLayout.sequenceLayout(13, stdio_string.C_POINTER).withName("__names")
