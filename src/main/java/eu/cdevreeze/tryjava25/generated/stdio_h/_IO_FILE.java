...
public class _IO_FILE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        stdio_h.C_INT.withName("_flags"),
        MemoryLayout.paddingLayout(4),
        stdio_h.C_POINTER.withName("_IO_read_ptr"),
        stdio_h.C_POINTER.withName("_IO_read_end"),
        stdio_h.C_POINTER.withName("_IO_read_base"),
        stdio_h.C_POINTER.withName("_IO_write_base"),
        stdio_h.C_POINTER.withName("_IO_write_ptr"),
        stdio_h.C_POINTER.withName("_IO_write_end"),
        stdio_h.C_POINTER.withName("_IO_buf_base"),
        stdio_h.C_POINTER.withName("_IO_buf_end"),
        stdio_h.C_POINTER.withName("_IO_save_base"),
        stdio_h.C_POINTER.withName("_IO_backup_base"),
        stdio_h.C_POINTER.withName("_IO_save_end"),
        stdio_h.C_POINTER.withName("_markers"),
        stdio_h.C_POINTER.withName("_chain"),
        stdio_h.C_INT.withName("_fileno"),
        stdio_h.C_INT.withName("_flags2"),
        stdio_h.C_LONG.withName("_old_offset"),
        stdio_h.C_SHORT.withName("_cur_column"),
        stdio_h.C_CHAR.withName("_vtable_offset"),
        MemoryLayout.sequenceLayout(1, stdio_h.C_CHAR).withName("_shortbuf"),
        MemoryLayout.paddingLayout(4),
        stdio_h.C_POINTER.withName("_lock"),
        stdio_h.C_LONG.withName("_offset"),
        stdio_h.C_POINTER.withName("_codecvt"),
        stdio_h.C_POINTER.withName("_wide_data"),
        stdio_h.C_POINTER.withName("_freeres_list"),
        stdio_h.C_POINTER.withName("_freeres_buf"),
        stdio_h.C_LONG.withName("__pad5"),
        stdio_h.C_INT.withName("_mode"),
        MemoryLayout.sequenceLayout(20, stdio_h.C_CHAR).withName("_unused2")
    ).withName("_IO_FILE");
